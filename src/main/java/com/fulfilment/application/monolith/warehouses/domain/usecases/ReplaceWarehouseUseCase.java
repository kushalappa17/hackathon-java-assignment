...
public class ReplaceWarehouseUseCase implements ReplaceWarehouseOperation {
  ...
  public ReplaceWarehouseUseCase(WareHouseValidator wareHouseValidator) {
...
//    }
    ...
    WareHouseValidator.ValidatedWarehouse validated =  this.wareHouseValidator.validateExistingAndLocation(newWarehouse);
    validated.existing().location = newWarehouse.location;
    validated.existing().capacity = newWarehouse.capacity;
    validated.existing().stock = newWarehouse.stock;
